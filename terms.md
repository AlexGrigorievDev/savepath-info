...
- You can manage or cancel subscriptions in your Apple ID settings: Settings → Apple ID → Subscriptions.
- Any unused portion of a free trial period (if offered) will be forfeited when you purchase a subscription.

Prices may vary by country/region and may change. Taxes may apply where required.
...
- Списание за продление происходит в течение 24 часов до окончания текущего периода.
- Управлять подпиской и отменять её можно в настройках Apple ID: Настройки → Apple ID → Подписки.
- Неиспользованная часть пробного периода (если он предоставляется) сгорает при оформлении подписки.

Цена может отличаться в зависимости от страны/региона и может изменяться. В применимых случаях могут начисляться налоги.
...
Мы можем периодически обновлять Условия. Дата обновления указана вверху. Продолжая пользоваться Приложением после изменений, вы принимаете обновлённые Условия.
